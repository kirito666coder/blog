    ...
    <section ref={containerRef} className="py-24 lg:py-40">
      <div className="flex flex-col gap-12">
        ...
        >
          ...
          architecting{' '}
          <span className="text-red-500 underline decoration-red-500/30">resilient</span> systems.
        </h2>

        <p className="text-muted-foreground max-w-2xl text-lg leading-relaxed md:text-xl">
          I don&apos;t just build features; I engineer scalable ecosystems. My blog is a laboratory
          for deep dives into distributed systems, low-level optimization, and the art of building
          software that survives the test of extreme scale.
        </p>
