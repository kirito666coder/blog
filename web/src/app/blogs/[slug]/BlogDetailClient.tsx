...
const markdownComponents: Components = {
  ...
  h2: ({ children }) => (
    <h2 className="mt-10 mb-4 text-2xl font-bold md:text-3xl">{children}</h2>
  ),
  h3: ({ children }) => (
    <h3 className="mt-8 mb-3 text-xl font-semibold md:text-2xl">{children}</h3>
  ),
  p: ({ children }) => (
  ...
  li: ({ children }) => (
    <li className="text-muted-foreground my-2 ml-6 list-disc">{children}</li>
  ),
